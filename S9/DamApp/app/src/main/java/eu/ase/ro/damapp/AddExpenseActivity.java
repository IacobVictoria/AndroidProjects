...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    public static final String POSITION_SELECTED = "selected_position";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Expense expense = intent.getParcelableExtra(EXPENSE_KEY);
        if(expense != null) {
            ...
            ArrayAdapter<String> arrayAdapter = (ArrayAdapter<String>) spnCategory.getAdapter();
            int position = arrayAdapter.getPosition(expense.getCategory());
            spnCategory.setSelection(position);
            position = intent.getIntExtra(POSITION_SELECTED,-1);
        }
    }
